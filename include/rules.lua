...
awful.rules.rules = {
    ...
    { rule_any                              = {
        instance                            = { "DTA", "copyq", },
        class                               = {
            "Arandr", "Gpick", "Kruler", "MessageWin", "TeamViewer","Sxiv", "Wpa_gui", "pinentry", "veromix", "xtightvncviewer", "Xscreensaver-demo", "Lxtask", "Gnome-system-monitor", "Speedcrunch", "Gnome-calculator", --[["Leafpad",]]
